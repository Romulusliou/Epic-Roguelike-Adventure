# enemy/spawner.py
import random
# from enemy.enemy import Enemy, enemies # Commented out as Enemy is not used here after commenting out spawn_enemy, and enemies is also part of the commented out logic
# from game.wave_manager import current_wave, remaining_enemies_to_spawn, is_wave_cleared, next_wave # Commented out as these are part of the redundant system


# bombs = [] # Seems unused by the core game logic in game/game.py
# current_wave = 1
# max_waves = 3
# wave_interval = 5000
# last_wave_time = 0
